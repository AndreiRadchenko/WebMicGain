  ...
  namespace Menu {
    ...
    public:
      ...
      void begin() {
        ...
        //PCattachInterrupt<pinA>(mixHandler(encoderInUpdateA,this), CHANGE);
        //PCattachInterrupt<pinB>(mixHandler(encoderInUpdateB,this), CHANGE);
        /*
        Serial.print("encoder.begin() at pins: ");
        Serial.print(pinA);
        Serial.print(", ");
        Serial.println(pinB);
        */
